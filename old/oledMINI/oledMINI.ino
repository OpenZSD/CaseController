...
void draw_ring_seg()
{
  for(int i = 20; i < 30; i++)
  {
    Draw_Circle64k(64,64,i, MAKECOLOR64k(255,255,255), MAKECOLOR64k(0,255,0));
  }
...
void draw_gear(int rad, float rot)
{
  int tooth = rad/3;
  int innerRad = rad - 20;
  ...
  int ty[360];
  int i = 0;
  for(float r = 0.0; r < 6.282; r += 1.04)
  {
    tx[i] = (rad * sin(r+rot)) + 64;
    ty[i] = (rad * cos(r+rot)) + 64;
    i++;
  }
  
  EnableFill(0x01);
  Draw_Circle64k(64,64,rad, MAKECOLOR64k(0,0,0), MAKECOLOR64k(200,200,255));
  Draw_Circle64k(64,64,innerRad, MAKECOLOR64k(0,0,0), MAKECOLOR64k(0,0,0));
  Draw_Circle64k(64,64,10, MAKECOLOR64k(0,0,0), MAKECOLOR64k(100,100,255));
  for(int j = 0; j < i; j++)
  {
    Draw_Circle64k(tx[j],ty[j],tooth, MAKECOLOR64k(0,0,0), MAKECOLOR64k(0,0,0));
  }
}
...
void setup() {
 ...
 /* draw_lines();
  ...
  while(1)
  {
    ...
    Draw_Circle64k(64,64,10, MAKECOLOR64k(0,0,0), MAKECOLOR64k(255,100,100));
    delay(480000);
  }
